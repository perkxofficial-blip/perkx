          ...
          products: {
            ...
            items: {
              ...
              properties: {
                ...
                exchange_signup_link: { type: 'string' },
                product_name: { type: 'string' },
                discount: { type: 'number' },
                default_fee_maker: { type: 'number' },
                default_fee_taker: { type: 'number' },
                final_fee_maker: { type: 'number' },
                final_fee_taker: { type: 'number' },
                ave_rebate: { type: 'number', nullable: true },
                created_at: { type: 'string', format: 'date-time' },
                updated_at: { type: 'string', format: 'date-time' },
              },
            },
